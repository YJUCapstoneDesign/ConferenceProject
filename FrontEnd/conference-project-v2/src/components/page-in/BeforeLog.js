function BeforeLog() {
    return (
        // <div class="w-full xl:w-7/12 mb-12 xl:mb-0 ml-4">
          <div class="relative flex flex-col min-w-0 break-words bg-white h-custom-height w-custom-size mt-4 mb-6  shadow-lg rounded" style={{ minHeight: '360px' }}>
            <div class="rounded-t mb-0 px-4 py-3 border-0">
              <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                  <h3 class="font-semibold text-base text-indigo-500">Previous meeting records</h3>
                </div>
