  ...
  return (
    <div className="wrap bg-slate-50" id="wrap">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 w-full gap-8 m-10 auto-rows-auto">
        ...
        <div className="col-span-2 backdrop-blur-sm bg-white p-6 rounded-md shadow-sm cursor-pointer border-2 border-gray-50 hover:border-indigo-300 transition-colors duration-500 h-80">
        ...
        <div className="backdrop-blur-sm bg-white p-6 rounded-md shadow-sm cursor-pointer border-2 border-gray-50 hover:border-indigo-300 transition-colors duration-500 h-80">
          <div className="sm:mt-4 lg:mt-4 xl:mt-4">
            <div className="flex justify-end sm:justify-start lg:justify-end xl:justify-start -space-x-1.5">
            </div>
          </div>
