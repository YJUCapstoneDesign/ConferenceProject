...
function NoticePageContents() {
    return (
        <section class=" bg-blue-500ray-50 bg-[#18185e] lg:w-svm lg:h-svh sm:w-svm sm:h-svm">
            <Navbar />
            <div class="sm:py-16 block lg:py-8 relative bg-opacity-50 z-40 overflow-hidden">
                    ...
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                        <div class="max-w-xl mx-auto text-center">
                            <div class="inline-flex px-4 py-1.5 mx-auto rounded-full  ">
                                <p class="text-4xl font-semibold tracking-widest text-g uppercase text-white">
                                    UNMUTE:
                                </p>
                            </div>
                            <p class="mt-4 text-base leading-relaxed text-white group-hover:text-white">
                        ...
                        <div class="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                            <a
                                href="/"
                                class="transition-all  duration-1000 bg-white hover:bg-[#0094C6]  hover:shadow-xl m-2 p-4 relative z-40 group"
                            >
                                ...
                                <div class="py-2 px-9 relative">
                                    <svg
                                        class="w-16 h-16 fill-gray-600 group-hover:fill-white"
                                        viewBox="0 0 32 32"
                                        id="polo-tshirt"
                                    >
                            ...
                            <a
                                href="/"
                                class="transition-all  duration-1000 bg-white hover:bg-[#d8dddf]  hover:shadow-xl m-2 p-4 relative z-40 group  "
                            >
                                <div class=" absolute  bg-blue-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  "></div>
                                <div class="py-2 px-9 relative  ">
                                    <svg
...
export default NoticePageContents;
