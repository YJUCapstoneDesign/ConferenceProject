        ...
        <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
          ...
          <form>
            <div className="mb-6">
              ...
              <input type="text" id="text" name="text" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-700"onChange={(e) => setMeetingId(e.target.value)} required placeholder="Meeting id" />
            </div>
            <div className="mb-6">
              <label htmlFor="name" className="block mb-2 text-sm text-gray-600"></label>
            ...
            <button type="submit" className="w-32 bg-gradient-to-r from-indigo-700 to-cyan-600 text-white py-2 rounded-lg mx-auto block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 mt-4 mb-4" onClick={CreateRoom}>입 장</button>
          </form>
