        ...
        <div className="w-full" id='About'>
            <div className="flex bg-white" style={{ height: '600px' }}>
                ...
                <div className="hidden lg:block lg:w-1/2" style={{ clipPath: 'polygon(10% 0, 100% 0%, 100% 100%, 0 100%)' }}>
                    <div className="h-full object-cover" style={{ backgroundImage: 'url(https://plus.unsplash.com/premium_photo-1664302656889-e0ff44331843?q=80&w=3846&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)' }}>
