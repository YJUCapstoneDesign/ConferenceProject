...
function Sidebar({teamNumber}) {
    ...
    const OpenPopupCrazy = () => {
        window.open(`/Crazy/${teamNumber}`,"Crazy","width=900px,height=600px");
    }
        ...
        <div className="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 ease-in-out duration-500  hover:bg-white hover:shadow-lg"> {/* hover시 느리게 화면 크기 변경 ease-in-out duration */}
          <div className="flex h-screen flex-col justify-between pt-2 pb-6">
            <div>
                ...
                <li className="min-w-max cursor-pointer" onClick={OpenPopupCrazy}>
                    <div className="group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
                    ...
                    <span className="group-hover:text-gray-700 text-base">Crazy Eight</span>
                    </div>
                </li>   
                <li className="min-w-max cursor-pointer" onClick={OpenPopupSWOT}>
                    <div className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600" fill="currentColor">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='h-5 w-5'>
                        <path d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM9 9H5V5h4v4zm5 2h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1zm1-6h4v4h-4V5zM3 20a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v6zm2-5h4v4H5v-4zm8 5a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6zm2-5h4v4h-4v-4z" className="fill-current text-gray-600 group-hover:text-indigo-600">
                        </path> 
                    </svg>
                    <span className="group-hover:text-gray-700 text-base">Swot</span>
                    </div>
                </li>
                <li className="min-w-max cursor-pointer" onClick={OpenPopupHat}>
                    <div className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600" fill="currentColor">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='h-5 w-5'>
                        <path className="fill-current text-gray-600 group-hover:text-indigo-600" d="M21 15c0-4.625-3.507-8.441-8-8.941V4h-2v2.059c-4.493.5-8 4.316-8 8.941v2h18v-2zM5 15c0-3.859 3.141-7 7-7s7 3.141 7 7H5zm-3 3h20v2H2z"></path>
                    </svg>
                    <span className="group-hover:text-gray-700 text-base">Thinking Hat</span>
                    </div>
                </li>
                <li className="min-w-max cursor-pointer" onClick={OpenPopupMind}>
                    <div className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600" fill="currentColor">
                    ...
                    <span className="group-hover:text-gray-700 text-base">MindMap</span>
                    </div>
                </li>
                <li className="min-w-max cursor-pointer" onClick={OpenPopupWhite}>
                    ...
                    <span className="group-hover:text-gray-700 text-base">White Board</span>
                    </div>
                </li>
                </ul>
            </div>
