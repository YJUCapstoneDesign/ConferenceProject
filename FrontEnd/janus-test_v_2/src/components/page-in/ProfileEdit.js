...
function ProfileEdit() {
  ...
  return (
    <div>
      ...
      <div className="max-w-lg mx-auto mt-48 bg-white rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <h2 className="text-2xl font-semibold text-black mb-10">Edit Profile!</h2>
              ...
              <input
                ...
                className="w-full px-3  py-2 rounded-md border border-gray-300focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>

            <div className="flex items-start flex-col justify-start">
              <label htmlFor="phone" className="text-sm text-gray-700 mr-2">Phone:</label>
              <input
                type="text"
                id="phone"
                name="phone"
